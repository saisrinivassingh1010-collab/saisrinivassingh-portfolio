...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SAI SRINIVAS SINGH — Film & Video Editor Portfolio" },
      { name: "description", content: "Premium portfolio of SAI SRINIVAS SINGH, a senior film & video editor crafting cinematic stories for global brands." },
      { property: "og:title", content: "SAI SRINIVAS SINGH — Film & Video Editor" },
